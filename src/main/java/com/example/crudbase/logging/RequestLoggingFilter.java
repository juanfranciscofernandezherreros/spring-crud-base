 ...
 *
 * <p>Registered explicitly as a bean in {@link com.example.crudbase.config.BeanConfig}
 * rather than via {@code @Component} — Spring Boot auto-registers any
 * {@code Filter} bean it finds in the context regardless of how it got
 * there, so no stereotype annotation is needed here.
 */
